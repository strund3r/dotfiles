# Generated by Powerlevel10k configuration wizard on 2022-02-16 at 14:56 -03.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX= #"%{%B%F{black}%K{green}%} $usr_symbol%{%b%f%k%F{green}%}? %{%f%}"
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=242 # 238
  ...
  typeset -g POWERLEVEL9K_ASDF_RUBY_FOREGROUND='#ffffff'
  typeset -g POWERLEVEL9K_ASDF_RUBY_BACKGROUND='#cc342d'
  # typeset -g POWERLEVEL9K_ASDF_RUBY_VISUAL_IDENTIFIER_EXPANSION='⭐'
  # typeset -g POWERLEVEL9K_ASDF_RUBY_SHOW_ON_UPGLOB='*.foo|*.bar'

  # Python version from asdf.
  typeset -g POWERLEVEL9K_ASDF_PYTHON_FOREGROUND='#ffde57'
  typeset -g POWERLEVEL9K_ASDF_PYTHON_BACKGROUND='#4584b6'
  # typeset -g POWERLEVEL9K_ASDF_PYTHON_VISUAL_IDENTIFIER_EXPANSION='⭐'
  # typeset -g POWERLEVEL9K_ASDF_PYTHON_SHOW_ON_UPGLOB='*.foo|*.bar'

  # Go version from asdf.
  typeset -g POWERLEVEL9K_ASDF_GOLANG_FOREGROUND='#ffffff'
  typeset -g POWERLEVEL9K_ASDF_GOLANG_BACKGROUND='#00add8'
...
#4ea624
  ...
  typeset -g POWERLEVEL9K_TERRAFORM_VERSION_FOREGROUND='#ffffff'
  typeset -g POWERLEVEL9K_TERRAFORM_VERSION_BACKGROUND='#7B42BC' # 623CE4
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_AWS_DEFAULT_BACKGROUND='#232F3E'
  ...
  typeset -g POWERLEVEL9K_AZURE_FOREGROUND='#FFFFFF'
  typeset -g POWERLEVEL9K_AZURE_BACKGROUND='#008AD7'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_GCLOUD_BACKGROUND='#0086f8'
  ...
  #   typeset -g my_wifi_icon=('nf-fa-wifi' 'nf-mdi-wifi' 'nf-mdi-wifi_off')     # <-- change these values
  #
